...
let AddmentorToMenteeService = class AddmentorToMenteeService {
    constructor(_http, _mentordetail) {
        this._http = _http;
        this._mentordetail = _mentordetail;
    }
    AddMentorToMentee(cateogry, Schedule, Mentorname, Menteename) {
        ...
        let connection = this._mentordetail.connectionstring() + 'AddMentorToMentee';
        return this._http.get(connection, { search: params })
            .map(resp => resp.json());
    }
};
AddmentorToMenteeService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, app_mentormentee_1.mentordetail])
], AddmentorToMenteeService);
exports.AddmentorToMenteeService = AddmentorToMenteeService;
//# sourceMappingURL=app.service.addmentortomentee.js.map